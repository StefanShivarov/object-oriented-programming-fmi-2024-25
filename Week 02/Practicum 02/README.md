# 🖥️ Тема 2: Текстови файлове. 🖥️
## Задача 0:
Модифицирайте задачата която решихме в предния практикум (N_Triangle), така че да прочита данните си от файл и да ги запазва във файл
## Задача 1
